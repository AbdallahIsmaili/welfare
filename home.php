    ...
    <div class="container">
      <div class="row gy-4 d-flex justify-content-between">
        ...
        <div class="col-lg-5 order-1 order-lg-2 hero-img" data-aos="zoom-out">
          <img src="public/assets/img/hero-img.svg" class="img-fluid mb-3 mb-lg-0" alt="">
        </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="card">
              <div class="card-img">
                <img src="public/assets/img/storage-service.jpg" alt="" class="img-fluid">
              </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="card">
              <div class="card-img">
                <img src="public/assets/img/logistics-service.jpg" alt="" class="img-fluid">
              </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="card">
              <div class="card-img">
                <img src="public/assets/img/cargo-service.jpg" alt="" class="img-fluid">
              </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="card">
              <div class="card-img">
                <img src="public/assets/img/trucking-service.jpg" alt="" class="img-fluid">
              </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
            <div class="card">
              <div class="card-img">
                <img src="public/assets/img/packaging-service.jpg" alt="" class="img-fluid">
              </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
            <div class="card">
              <div class="card-img">
                <img src="public/assets/img/warehousing-service.jpg" alt="" class="img-fluid">
              </div>
    ...
    <section id="features" class="features">
      <div class="container">
        ...
        <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
          ...
          <div class="col-md-5">
            <img src="public/assets/img/features-1.jpg" class="img-fluid" alt="">
          </div>
          <div class="col-md-7">
        ...
        <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
          <div class="col-md-5 order-1 order-md-2">
            <img src="public/assets/img/features-2.jpg" class="img-fluid" alt="">
          </div>
        ...
        <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
          <div class="col-md-5">
            <img src="public/assets/img/features-3.jpg" class="img-fluid" alt="">
          </div>
          <div class="col-md-7">
        ...
        <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
          <div class="col-md-5 order-1 order-md-2">
            <img src="public/assets/img/features-4.jpg" class="img-fluid" alt="">
          </div>
          <div class="col-md-7 order-2 order-md-1">
