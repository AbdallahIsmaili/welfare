      ...
      <div class="row gy-4 d-flex justify-content-between">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <form action="restore-password.php" method="POST">
                  ...
                  <?php
                    if(isset($_GET['email'])){
                      echo "<input type='email' name='email' class='form-control' value='$e' placeholder='Enter your email' readonly>";
                    }else{
                      echo "<input type='email' name='email' class='form-control' value='$e' placeholder='Enter your email'>";
                    }
                  ?>
